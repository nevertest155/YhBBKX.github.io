...
class SmartPreloader {
    constructor() {
        ...
        this.resources = [
            ...
            {
                id: 'screenshot-icon',
                url: 'https://raw.githubusercontent.com/nevertest155/YhBBKX.github.io/main/screenshot%20(2).png',
                type: 'image',
                priority: 'high',
                fallback: 'data:image/svg+xml;base64,'
            },
            
            // 新增：Better Minecraft图标
            {
                id: 'better-minecraft-icon',
                url: 'https://raw.githubusercontent.com/nevertest155/YhBBKX.github.io/main/Better%20Minecraft%20Preview_1.21.130.24.apk_icon.png',
                type: 'image',
                priority: 'medium',
                fallback: 'data:image/svg+xml;base64,'
            },
            
            // 新增：原版优化整合包图标
            {
                id: 'vanilla-optimization-icon',
                url: 'https://raw.githubusercontent.com/nevertest155/YhBBKX.github.io/main/%E5%8E%9F%E7%89%88%E4%BC%98%E5%8C%96%E6%95%B4%E5%90%88%E5%8C%85_1.0.0.apk_icon.png',
                type: 'image',
                priority: 'medium',
                fallback: 'data:image/svg+xml;base64,'
            },
        ...
        console.log('📦 [SmartPreloader] 总资源数:', this.resources.length);
    }
    ...
    async loadByPriority() {
        ...
        console.log(`📦 [SmartPreloader] 资源分组: critical=${critical.length}, high=${high.length}, medium=${medium.length}`);
    ...
    applyFallback(resource) {
        ...
        if (resource.type === 'image' && resource.fallback.startsWith('data:')) {
            ...
            switch(resource.id) {
                case 'logo-32':
                    selector = '.app-bar-title img[src*="Minecraft Yh for Beta"]';
                    break;
                case 'logo-160':
                    selector = '.hero-logo img[src*="Minecraft Yh for Beta"]';
                    break;
                case 'screenshot-icon':
                    selector = '.screenshot-icon';
                    break;
                case 'better-minecraft-icon':
                    selector = 'img.nav-icon[src*="Better Minecraft"]';
                    break;
                case 'vanilla-optimization-icon':
                    selector = 'img.nav-icon[src*="原版优化整合包"]';
                    break;
                default:
                    selector = `img[src*="${resource.url}"], img[src="${resource.url}"]`;
            }
            ...
            images.forEach(img => {
                if (img.src === resource.url || img.src.includes(resource.url)) {
                    ...
                    console.log(`🔄 替换图片: ${resource.id} -> 备用图片`);
                }
            });
        }
    }
